...
<h2 class="post-title">
    <a href="index.php?page=tintucct&matt=<?php echo $r[0]?>" title="<?php echo $r[1]?>"style="color:black;"><?php echo $r[1]?></a></h2>
</header>
...
<div class="excerpt" style="color:#F16529">
    <?php echo substr($r[3],0,500)?>...
 </div>
<a href="index.php?page=tintucct&matt=<?php echo $r[0]?>" style="color:#20002c ;text-transform: uppercase !important;">ĐỌC TIẾP</a>
<div class="clear"></div>
</div>
...
<time style="color:#F16529" datetime="<?php echo $r[4]?>"><?php echo $r[4]?></time> </div>
</div></div> </article></div>
    <?php
    }
    ?>
