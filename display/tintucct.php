...
<ul class="breadcrumb breadcrumb__t" style="background:transparent !important"><li><a href="index.php">Trang chủ</a></li><li class="divider"></li><li class="active"><?php echo $r[1]?></li></ul>  
</section>  </div>
</div>
<div class="row">
<div class="span11 right" id="content" data-motopress-type="loop" data-motopress-loop-file="loop/loop-blog.php">
    <h2><?php echo $r[1]?></h2>
    <div style="color:#20002c">
